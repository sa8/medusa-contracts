...
# Depoloy DOnlyfans
testnet_deployDonlyFans:; forge script script/DeployDOnlyFans.s.sol:DeployDOnlyFans --rpc-url https://goerli-rollup.arbitrum.io/rpc --broadcast -vvvv --skip-simulation --slow
